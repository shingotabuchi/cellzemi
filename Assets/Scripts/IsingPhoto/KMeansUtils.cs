...
public static class KMeans {
    ...
    public static KMeansResults Cluster(double[][] data, int clusterCount, int maxIterations, int seed) {
        ...
        // Return the results
        return new KMeansResults(clusters, means, centroidIdx, totalDistance,iteration);
    }
...
public class KMeansResults {
    ...
    public readonly int itersTaken;

    public KMeansResults(int[][] clusters, double[][] means, int[] centroids, double totalDistance, int itersTaken) {
        this.clusters = clusters;
        this.means = means;
        this.centroids = centroids;
        this.totalDistance = totalDistance;
        this.itersTaken = itersTaken;
    }
}
